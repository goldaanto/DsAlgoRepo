...
Scenario: Check the Register Link
    ...
    Scenario: Check Before login get started button of Data Structure - intro tab.
    Given User is in the home page 
    When user clicks the DataStruct Get Started button
     Then User navigated to error home page  
     
    Scenario: Check Before login get started button of Array tab.
    Given User is in the home page 
    When user clicks the Array Get Started button
    Then User navigated to error home page    
   
      
  Scenario: Check Before login get started button of Linked List tab.
    Given User is in the home page 
    When user clicks the Linked Get Started button
    Then User navigated to error home page
    
   
    Scenario: Check Before login get started button of Stack  tab.
    Given User is in the home page 
    When user clicks the Stack Get Started button
    Then User navigated to error home page
   
    Scenario: Check Before login get started button of Queue tab.
    Given User is in the home page 
    When user clicks the Queue Get Started button
    Then User navigated to error home page
    
    Scenario: Check Before login get started button of tree tab.
    Given User is in the home page 
    When user clicks the Tree Get Started button
    Then User navigated to error home page
    
    Scenario: Check Before login get started button of graph tab.
    Given User is in the home page 
